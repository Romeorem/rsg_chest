...
3. Ajouter les items dans `rsg-core/shared/items.lua` :
```lua
chest_medium    = { name = 'chest_medium',    label = 'Coffre',          weight = 8000, type = 'item', image = 'chest_medium.png',    unique = false, useable = true, shouldClose = true, description = 'Un coffre à code à poser' },
chest_small     = { name = 'chest_small',     label = 'Petit coffre',    weight = 5000, type = 'item', image = 'chest_small.png',     unique = false, useable = true, shouldClose = true, description = 'Un petit coffre à code' },
chest_trunk     = { name = 'chest_trunk',     label = 'Malle de voyage', weight = 8000, type = 'item', image = 'chest_trunk.png',     unique = false, useable = true, shouldClose = true, description = 'Une malle à code' },
chest_large     = { name = 'chest_large',     label = 'Grande malle',    weight = 12000, type = 'item', image = 'chest_large.png',    unique = false, useable = true, shouldClose = true, description = 'Une grande malle à code' },
chest_strongbox = { name = 'chest_strongbox', label = 'Coffre-fort',     weight = 15000, type = 'item', image = 'chest_strongbox.png', unique = false, useable = true, shouldClose = true, description = 'Un coffre-fort à code' },
```
