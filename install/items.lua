-- ============================================================
--  rsg_chest — Liste des items
--  À copier dans : rsg-core/shared/items.lua  (dans la table RSGShared.Items)
--  Images à placer dans : rsg-inventory/html/images/
-- ============================================================

    chest_medium    = { name = 'chest_medium',    label = 'Coffre',          weight = 8000,  type = 'item', image = 'chest_medium.png',    unique = false, useable = true, shouldClose = true, description = 'Un coffre à code à poser (p_chestmedburied01x)' },
    chest_small     = { name = 'chest_small',     label = 'Petit coffre',    weight = 5000,  type = 'item', image = 'chest_small.png',     unique = false, useable = true, shouldClose = true, description = 'Un petit coffre à code à poser' },
